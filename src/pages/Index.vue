  ...
  <div class="bg">
    <page-layout>
      <div slot="slotHeader" class="page-header">
        <div class="header-name" style="top:65%">
          <img src="../assets/imgs/tq-logo.png" alt />
        </div>
      </div>
      <div slot="slotContent" class="wrap">
        <!-- 左侧区域 -->
        <div class="left">
          <title-bar text="TOTAL PROJECTS"></title-bar>
          <div class="module">
            <circle-show :data="statisticsData.projectTotal"></circle-show>
          </div>
          <title-bar text="NUMBER OF ALARMS"></title-bar>
          <div class="module">
